...
// Folders to remove (confirmed duplicates)
const foldersToRemove = [
  'bryan-adams-everything-i-do-i-do-it-for-you-heart',
  'ed-sheeran-perfect-guitar-3'
];

console.log('🗑️  REMOVING CONFIRMED DUPLICATE FOLDERS AND DATABASE ENTRIES...\n');
...
async function removeFromRailwayDatabase(folderName) {
  ...
  try {
    ...
    const result = await client.query(
      'DELETE FROM designs WHERE image_url LIKE $1',
      [`%${folderName}%`]
    );
